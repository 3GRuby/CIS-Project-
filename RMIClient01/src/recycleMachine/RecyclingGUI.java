...
public class RecyclingGUI extends JFrame  {
	...
	public static int maximumWeight=10000;
	public static int maximumSize=1000;
	...
	public RecyclingGUI() throws Exception {
		...
		boolean b = servo.checkRegisterStatus(getPublicIpAddress(), "NEW CLIENT");
		if(b){
			loadDesign();
			gui=this;
			this.setVisible(true);
			
			Vector vecReturn=servo.getCientDetails(RecyclingGUI.getPublicIpAddress());
...
//                	
//            		boolean b = servo.engineersLogin(jTextField1.getText(), String.valueOf(jPasswordField1.getPassword()), RecyclingGUI.getPublicIpAddress());
//                	
//                	if(b){
//                		
//                	}else{
...
//                	}
	...
	public void loadDesign() {
		jMenu1.setText("File");
        jMenuItem1.setText("Engineer Login");
...
//		heading.setFont(new Font("Calibri", Font.BOLD, 25));
		...
		ImageIcon image = new ImageIcon("C:/reSizeSmall.gif");

		imageLBL.setIcon(image);
		panel2.add(imageLBL);
		dataLine.setText("Maximum | Weight : "+maximumWeight+" | Size : "+maximumSize+" | ");
		panel2.add(dataLine);
		dataLine2.setText("Current | Weight : "+ReceiptBasis.collectedWeight+" | Size : "+ReceiptBasis.collectedSize);
