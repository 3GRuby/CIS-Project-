			...
			if( e.getActionCommand().equals(Server.jMenuItem1.getActionCommand()) ) {
				try {
		            ...
		            if (result == JOptionPane.OK_OPTION) {
						...
						Server.x2.servoCC.loadRegisteredEngineers();
//						
		            }
		        } catch (Exception ex) {
		        	ex.printStackTrace();
...
//				}
				...
				chat.setName("Server"+"("+Server.x2.servoCC.getPublicIpAddress()+")");
...
//				}
				...
				Server.x2.servoCC.loadChatHistoryServer();
...
//				    public static ArrayList<ResetRequests> resetRequests = new ArrayList();
			...
			}else if( e.getActionCommand().equals(Server.itemsClientsCombo.getActionCommand()) ) {
