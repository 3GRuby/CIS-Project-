...
//            	if(!timeBefore.equals(time)){
            		...
            		for(ConnectionRequest c2:Server.connectionRequests){
            			if(c.getIpAddress().equals(c2.getClient().getIpAddress())){
            				Server.connectionRequests.remove(c2);
            				c2.setStatus(2);
            				Server.connectionRequests.add(c2);
            				break;
            			}
            		}
